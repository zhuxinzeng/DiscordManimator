...
class TestRenderConfig:
    ...
    def test_default_values(self):
        ...
        config = RenderConfig()
        assert config.no_docker is False
        assert config.use_onlinetex is False
    
    def test_custom_values(self):
        """Test custom values."""
        config = RenderConfig(no_docker=True, use_onlinetex=True)
        assert config.no_docker is True
...
class TestConfig:
    ...
    def test_minimal_config(self):
        ...
        config = Config(token="test_token_123_this_is_a_valid_discord_bot_token_1234567890")
        assert config.token.get_secret_value() == "test_token_123_this_is_a_valid_discord_bot_token_1234567890"
        assert config.bot.prefix == "!"
        assert config.render.no_docker is False
    ...
    def test_to_dict_includes_secrets(self):
        ...
        assert data["token"] == "test_token_123_this_is_a_valid_discord_bot_token_1234567890"
...
class TestConfigFromToml:
    ...
    def test_load_minimal_toml(self, tmp_path):
        ...
        config_file.write_text('token = "test_token_123_this_is_a_valid_discord_bot_token_1234567890"\n')
...
class TestGlobalConfig:
    ...
    def test_set_and_get_config(self):
        ...
        assert retrieved.token.get_secret_value() == "test_token_123_this_is_a_valid_discord_bot_token_1234567890"
...
class TestEnvironmentVariables:
    ...
    def test_env_override_token(self, monkeypatch):
        ...
        monkeypatch.setenv("DISCORDMANIMATOR_TOKEN", "env_token_123_this_is_a_valid_discord_bot_token_1234567890")
        config = Config()
        assert config.token.get_secret_value() == "env_token_123_this_is_a_valid_discord_bot_token_1234567890"
